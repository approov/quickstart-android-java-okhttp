...
* [MESSAGE SIGNING](https://github.com/approov/quickstart-android-java-okhttp/blob/master/MESSAGE-SIGNING.md): You should use this if you would like to ensure strict message integrity between the client app and the backend API where this additional level of integrity assurance is required.
